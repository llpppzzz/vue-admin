<template>
  <div class="tab-apply-list">
    <detail-block title="申卡订单">
      <el-table
        :data="creditCardOrderList"
        border
        fit
...
export default {
  ...
  computed: {
    creditCardOrderList() {
      return this.userInfo.data.creditCardOrderList || []
    },
    creditOrderList() {
      return this.userInfo.data.creditOrderList || []
    }
  }
}
</script>
